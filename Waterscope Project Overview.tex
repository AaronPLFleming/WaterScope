...
\end{enumerate}
The nature of this project means that not all of these principles must be, or even should be, achieved directly by us - the ultimate implementation of this project, and its conformity to these principes will be dependent on the behaviour of WaterScope. However, there are important aspects for us to consider ourselves.\\
